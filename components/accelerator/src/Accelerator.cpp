...
void Accelerator::registerChangeAccelerateCallback(
    AcceleratorChangeValueCallbackFunction const& acceleratorChangeValueCallbackFunction)
{
    m_acceleratorChangeValueCallbackFunction = acceleratorChangeValueCallbackFunction;
}

void Accelerator::process()
{
    if (not m_acceleratorChangeValueCallbackFunction)
    {
        return;
    }
